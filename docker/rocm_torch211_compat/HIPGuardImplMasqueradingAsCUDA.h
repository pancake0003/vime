...
// vime torch-2.11 compat: our restore step also appends these same structs to
// <c10/hip/HIPGuard.h> (which this header includes above) for TE, which never
// includes this ATen header. The shared VIME_HIP_MASQ_GUARDS_DEFINED sentinel
// ensures exactly one definition when aiter pulls in BOTH headers.
#ifndef VIME_HIP_MASQ_GUARDS_DEFINED
#define VIME_HIP_MASQ_GUARDS_DEFINED
...
#endif // VIME_HIP_MASQ_GUARDS_DEFINED
