...
SUITES = {
    "short": [
        ("test_qwen2.5_0.5B_fully_async_short-rocm.py", 4, "", {}, False),
        ("test_qwen3.5_0.8B_gsm8k_short.py", 4, "", {}, True),
        ("test_qwen3.5_0.8B_gsm8k_async_short.py", 4, "", {}, True),
    ],
    "vllm-config": [
        ("test_qwen2.5_0.5B_vllm_config-rocm.py", 8, "", {}, True),
        ("test_qwen2.5_0.5B_vllm_config_distributed-rocm.py", 8, "", {}, True),
        ("test_vllm_config_mixed_offload-rocm.py", 8, "", {}, True),
        ("test_vllm_config_mixed_offload_ft-rocm.py", 8, "", {}, True),
    ],
    "megatron": [
        ("test_full_disk_weight_update-rocm.py", 4, "", {}, True),
        ("test_quick_start_glm4_9B-rocm.py", 8, "", {}, True),
        ("test_glm4.7_30B_A3B_pd_mooncake-rocm.py", 8, "", {}, True),
        ("test_qwen3_30B_A3B-rocm.py", 8, "", {"USE_DEEPEP": "1", "USE_FP8_ROLLOUT": "1"}, True),
        ("test_qwen3.6_35B_A3B_pd_mooncake-rocm.py", 8, "", {"USE_DEEPEP": "1"}, True),
        ("test_qwen3_30B_A3B_r3-rocm.py", 8, "", {"USE_DEEPEP": "1", "USE_FP8_ROLLOUT": "1", "ENABLE_EVAL": "0"}, True),
        ("test_qwen3_30B_A3B_r3-rocm.py", 8, "", {"ENABLE_EVAL": "0"}, True),
        ("test_qwen3_4B_ppo-rocm.py", 8, "", {}, True),
        ("test_qwen3_4B_ppo_disaggregate-rocm.py", 8, "", {}, True),
        ("test_qwen3_4B_ppo_train_critic_only-rocm.py", 8, "", {}, True),
        ("test_ppo_logprob_entropy_gpu-rocm.py", 2, "", {}, True),
        ("test_release_train-rocm.py", 4, "", {}, True),
        ("test_qwen3_4B_streaming_partial_rollout-rocm.py", 8, "", {}, True),
        ("test_moonlight_16B_A3B-rocm.py", 8, "", {}, True),
        ("test_moonlight_16B_A3B_r3-rocm.py", 8, "", {"ENABLE_EVAL": "0"}, True),
        ("test_mimo_7B_mtp_only_grad-rocm.py", 8, "", {}, True),
        ("test_qwen2.5_0.5B_debug_rollout_then_train-rocm.py", 8, "", {}, True),
        ("test_qwen2.5_0.5B_opd_vllm-rocm.py", 8, "", {}, True),
        ("test_qwen3_4B_external_pd-rocm.py", 6, "", {}, True),
        ("test_qwen2.5_0.5B_fanout_short-rocm.py", 4, "", {}, True),
    ],
    "vime-customized": [
        ("test_qwen2_5_0_5B_non_colocate_pp-rocm.py", 4, "", {}, True),
    ],
    "precision": [
        ("test_qwen3_0.6B_parallel_check-rocm.py", 8, "", {}, True),
    ],
    "ckpt": [
        ("test_qwen3_4B_ckpt-rocm.py", 8, "--save-optimizer gpu --load-optimizer gpu", {}, True),
        ("test_qwen3_4B_ckpt-rocm.py", 8, "--save-optimizer gpu --load-optimizer cpu", {}, True),
        ("test_qwen3_4B_ckpt-rocm.py", 8, "--save-optimizer cpu --load-optimizer cpu", {}, True),
        ("test_qwen3_4B_ckpt-rocm.py", 8, "--save-optimizer cpu --load-optimizer gpu", {}, True),
        ("test_qwen3_4B_ckpt-rocm.py", 8, "--async-save", {}, True),
    ],
}
